...
import blog4 from "../../../assets/images/garden-working.jpg";
import blog5 from "../../../assets/images/homeImgs/skill.jpg";
import blog6 from "../../../assets/images/homeImgs/skill2.jpg";
        ...
        <div className="container mx-auto px-4">
            <div className="my-16">
                <div className="text-center">
                    ...
                    <h2 className="font-bold text-4xl">Creative Solutions</h2>
                </div>
